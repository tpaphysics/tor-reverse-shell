...
Every call the victim makes for `lsgbhtjko6zcrgsyb2nzdx76rpyaycvivl5tnmwyq336hlbqxjremcid.onion` will be redirected to the attacker **_socat_** server which is listening locally on port 80.
